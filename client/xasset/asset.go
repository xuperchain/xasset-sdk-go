...
// --------------------------商城SaaS----------------------------
func (t *AssetOper) genCreateOrAlterStoreBody(param *xbase.CreateOrAlterStoreParam) (string, error) {
	v := url.Values{}
...
func (t *AssetOper) CreateStore(param *xbase.CreateOrAlterStoreParam) (*xbase.BaseResp, *xbase.RequestRes, error) {
...
func (t *AssetOper) AlterStore(param *xbase.CreateOrAlterStoreParam) (*xbase.BaseResp, *xbase.RequestRes, error) {
	if param.StoreId < 1 {
...
func (t *AssetOper) genQueryStoreBody(param *xbase.BaseStoreParam) (string, error) {
	v := url.Values{}
	v.Set("store_id", fmt.Sprintf("%d", param.StoreId))
	body := v.Encode()
	return body, nil
...
func (t *AssetOper) QueryStore(param *xbase.BaseStoreParam) (*xbase.QueryStoreResp, *xbase.RequestRes, error) {
	if param.StoreId < 1 {
		return nil, nil, xbase.ErrParamInvalid
	}
...
func (t *AssetOper) ListStore() (*xbase.ListStoreResp, *xbase.RequestRes, error) {
...
func (t *AssetOper) genCreateOrAlterActBody(param *xbase.CreateOrAlterActParam) (string, error) {
	v := url.Values{}
	v.Set("store_id", fmt.Sprintf("%d", param.StoreId))
...
func (t *AssetOper) CreateAct(param *xbase.CreateOrAlterActParam) (*xbase.BaseResp, *xbase.RequestRes, error) {
	if err := param.CreateValid(); err != nil {
		return nil, nil, err
	}
...
func (t *AssetOper) AlterAct(param *xbase.CreateOrAlterActParam) (*xbase.BaseResp, *xbase.RequestRes, error) {
	if param.ActId < 1 {
		return nil, nil, xbase.ErrParamInvalid
	}
...
func (t *AssetOper) genPubActBody(param *xbase.BaseActParam) (string, error) {
	v := url.Values{}
	v.Set("act_id", fmt.Sprintf("%d", param.ActId))
...
func (t *AssetOper) PubAct(param *xbase.BaseActParam) (*xbase.BaseResp, *xbase.RequestRes, error) {
	if err := param.Valid(); err != nil {
		return nil, nil, xbase.ErrParamInvalid
	}
...
func (t *AssetOper) genBindOrAlterAstBody(param *xbase.BindOrAlterAstParam) (string, error) {
	v := url.Values{}
	v.Set("act_id", fmt.Sprintf("%d", param.ActId))
	v.Set("asset_id", fmt.Sprintf("%d", param.AssetId))
...
func (t *AssetOper) BindAst(param *xbase.BindOrAlterAstParam) (*xbase.BaseResp, *xbase.RequestRes, error) {
	if err := param.CreateValid(); err != nil {
		return nil, nil, err
	}
...
func (t *AssetOper) AlterAst(param *xbase.BindOrAlterAstParam) (*xbase.BaseResp, *xbase.RequestRes, error) {
...
func (t *AssetOper) genCancelAstBody(param *xbase.BaseAstParam) (string, error) {
	v := url.Values{}
	v.Set("act_id", fmt.Sprintf("%d", param.ActId))
	v.Set("asset_id", fmt.Sprintf("%d", param.AssetId))
	body := v.Encode()
...
func (t *AssetOper) CancelAst(param *xbase.BaseAstParam) (*xbase.BaseResp, *xbase.RequestRes, error) {
	if err := param.Valid(); err != nil {
		return nil, nil, err
	}
...
func (t *AssetOper) genCancelAstByActIdBody(param *xbase.BaseActParam) (string, error) {
	v := url.Values{}
	v.Set("act_id", fmt.Sprintf("%d", param.ActId))
	v.Set("is_box", fmt.Sprintf("%d", param.IsBox))
	body := v.Encode()
...
func (t *AssetOper) CancelAstByActId(param *xbase.BaseActParam) (*xbase.BaseResp, *xbase.RequestRes, error) {
	if err := param.Valid(); err != nil {
		return nil, nil, err
	}
...
func (t *AssetOper) genQueryActAstBody(param *xbase.BaseAstParam) (string, error) {
	v := url.Values{}
	v.Set("asset_id", fmt.Sprintf("%d", param.AssetId))
	v.Set("act_id", fmt.Sprintf("%d", param.ActId))
	body := v.Encode()
...
func (t *AssetOper) QueryActAst(param *xbase.BaseAstParam) (*xbase.QueryActAstResp, *xbase.RequestRes, error) {
...
func (t *AssetOper) genListActAstBody(param *xbase.BaseActParam) (string, error) {
	v := url.Values{}
	v.Set("act_id", fmt.Sprintf("%d", param.ActId))
	body := v.Encode()
	return body, nil
...
func (t *AssetOper) ListActAst(param *xbase.BaseActParam) (*xbase.ListActAstResp, *xbase.RequestRes, error) {
	if param.ActId < 1 {
		return nil, nil, xbase.ErrParamInvalid
	}
